...
y = y_encoded[~y_total.index.isin(private_list)]
...
# Transform private_labels using the fitted LabelEncoder
...
private_f1 = f1_score(private_labels_encoded, private_predictions, average='weighted')  # Adjust the 'average' parameter as needed
