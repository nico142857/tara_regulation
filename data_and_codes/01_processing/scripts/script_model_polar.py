...
def objective(params):
    ...
    score = cross_val_score(clf, X, y, scoring='f1', cv=rskf).mean()
...
private_f1 = f1_score(private_labels, private_predictions, average='binary')  # Adjust the 'average' parameter as needed
